package edu.osu.seclab.forwardexec;
...
import edu.osu.seclab.utility.FunctionUtility;
	...
	public void caseAssignStmt(AssignStmt stmt) {
		...
		if (leftop instanceof Local || leftop instanceof ParameterRef || leftop instanceof ArrayRef) {
			if (rightop instanceof InvokeExpr) {
				...
				else if (msig.equals("<java.lang.Byte: java.lang.Byte valueOf(byte)>")){
//					String val = Byte.valueOf(((InvokeExpr) rightop).getArg(0).).toString();
//					setInitValue(leftop, );
				}
				else {
			...
			} else if (rightop instanceof JAssignStmt) {
			}
			else {
