...
public class ApkContext {
	...
	public void init() throws ZipException, IOException, AndrolibException {
		...
		resTable = res.getResTable(apkFile, true);
...
//			}
			ResResSpec resSpec;
			try {
				resSpec = resTable.getResSpec(id);
			} catch (Exception e) {
				return null;
			}
			ResTypeSpec resTypeSpec = resSpec.getType();
			ResResource resResource = resSpec.getDefaultResource();
	...
	public static void main(String[] args) {
		String apk = "/home/wen.423/Desktop/CANHunter/app/diagnostic/com.iViNi.DrMercedesLite.apk";
		String s = ApkContext.getInstance(apk).findResource(2131296638);
		Logger.print(s);
	}
